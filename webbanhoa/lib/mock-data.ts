...
export const mockProducts: Product[] = [
  // Products mapped from files in /public/images
  {
    ...
    description:
      "Hoa hồng đỏ cao cấp nhập khẩu từ Ecuador, tươi lâu, màu đỏ thắm.",
    price: 450000,
  ...
  },
  {
    ...
    name: "Hoa Baby",
    description:
      "Hoa Baby trắng tinh khôi, thích hợp để trang trí và kết hợp bó hoa.",
    price: 120000,
    category: "Hoa baby",
    origin: "Việt Nam",
  ...
  },
  {
    ...
    description:
      "Cúc vạn thọ tươi, màu sắc rực rỡ, dùng nhiều trong trang trí.",
    price: 70000,
    category: "Hoa cúc",
    origin: "Việt Nam",
