        ...
        <Card className="border-rose-100 shadow-xl">
          <CardHeader className="text-center pb-2">
            <div className="w-16 h-16 bg-gradient-to-br from-rose-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-rose-50 font-bold text-2xl">H</span>
            </div>
              ...
              <TabsContent value="login">
                <div className="space-y-6">
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full border-rose-200 hover:bg-rose-50 text-rose-700 bg-transparent"
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-white px-2 text-rose-500">Hoặc</span>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          placeholder="••••••••"
                          required
                          className="border-rose-200 focus:border-rose-500 focus:ring-rose-500 pr-10"
                        />
                        <Button
                          type="button"
                          variant="ghost"
                  ...
                  name="phone"
                    ...
                    <div className="flex items-start space-x-2">
                      <input
                        ...
                        id="terms"
                        required
                        className="mt-1 rounded border-rose-300 text-rose-500 focus:ring-rose-500"
                      />
