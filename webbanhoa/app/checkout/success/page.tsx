    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-rose-50 p-6">
      <div className="max-w-2xl w-full bg-white shadow-lg rounded-2xl p-10 text-center">
        ...
        <div className="flex items-center justify-center mb-6">
          <div className="h-20 w-20 bg-rose-100 text-rose-600 rounded-full flex items-center justify-center text-4xl font-bold">
            ✓
          </div>
        </div>
        ...
        <p className="text-slate-600 mb-4">
          Cảm ơn quý khách đã tin tưởng sản phẩm của chúng tôi. Chúng tôi đã
          nhận được đơn hàng và sẽ xử lý sớm nhất có thể.
        </p>
        ...
        <div className="space-y-3">
          <Link href="/products">
            <Button className="w-48 mx-auto bg-gradient-to-r from-rose-500 to-pink-500 text-white">
              Quay lại trang sản phẩm
            </Button>
          </Link>
          <Link href="/">
            <Button variant="ghost" className="w-48 mx-auto">
              Về trang chủ
            </Button>
          </Link>
        </div>
