...
import { Search, Plus, Package, AlertTriangle, TrendingUp, Edit, Eye } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Theo dõi và quản lý tồn kho sản phẩm</p>
        </div>
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>Nhập thông tin sản phẩm mới vào kho</DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="description" placeholder="Mô tả chi tiết sản phẩm" />
              </div>
            </div>
            <DialogFooter>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Quản lý tồn kho và thông tin sản phẩm</CardDescription>
        </CardHeader>
        <CardContent>
              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <TableRow key={product.id}>
                    ...
                    <TableCell>{(product.price * product.inStock).toLocaleString("vi-VN")}₫</TableCell>
                            ...
                            <div className="grid gap-4 py-4">
                              ...
                              <div className="grid grid-cols-3 gap-4">
                                ...
                                <div className="space-y-2">
                                  ...
                                  <Input id="edit-stock" type="number" defaultValue={selectedProduct?.inStock} />
                                </div>
                                <div className="space-y-2">
                                  <Label htmlFor="edit-origin">Xuất xứ</Label>
                                  <Input id="edit-origin" defaultValue={selectedProduct?.origin} />
                                </div>
                              </div>
                              <div className="space-y-2">
